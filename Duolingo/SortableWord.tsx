		...
		onActive: ({ translationX, translationY }, ctx) => {
			...
			for (let i = 0; i < offsets.length; i++) {
				...
				if (
					...
					runOnJS(reorder)(offsets, offset.order.value, o.order.value);
					runOnJS(calculateLayout)(offsets, containerWidth);
					break;
				}
			}
